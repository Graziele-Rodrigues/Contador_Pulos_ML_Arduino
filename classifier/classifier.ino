...
int jumpCount = 0;  // Variável para contagem de pulos
int maxIndex = 0; // guardar index com maior score
float maxScore = 0; //guardar score maximo
  ...
  while (samplesRead < numSamples) {
    ...
    if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable()) {
      ...
      if (samplesRead == numSamples) {
        ...
        // If the gesture detected is "pulo", increment jump count
        if (maxIndex == 0 && maxScore > 0.7) {
          jumpCount++;
          Serial.print("Pulo detectado! Total de pulos: ");
